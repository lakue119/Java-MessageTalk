...
import com.example.choi.msgtalk.adapters.MessageListAdapter;
import com.example.choi.msgtalk.models.Chat;
import com.example.choi.msgtalk.models.Message;
import com.example.choi.msgtalk.models.PhotoMessage;
import com.example.choi.msgtalk.models.TextMessage;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_content_chat);
    ...
    private void uploadImage(Uri data){
        ...
        Task<Uri> urlTask = mImageStorageRef.putFile(data).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            @Override
...
//                if ( task.isSuccessful() ) {
//                    Task<Uri> a = task.getResult().getStorage().getDownloadUrl();
//
//                    mPhotoUrl =  task.getResult().getStorage().getDownloadUrl().toString();
//                    Log.i("AOIWJRLK",mImageStorageRef.getDownloadUrl().toString());
//                    Log.i("AOIWJRLK", String.valueOf(mImageStorageRef.getDownloadUrl()));
//                    Log.i("AOIWJRLK",task.getResult().getUploadSessionUri().toString());
//                    Log.i("AOIWJRLK",task.getResult().getStorage().getDownloadUrl().toString());
//
////                    mMessageType = Message.MessageType.PHOTO;
////                    sendMessage();
//
